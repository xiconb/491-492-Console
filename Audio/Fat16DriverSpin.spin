...
DAT
        success byte "Successful load", 0
        fail1 byte "Wrong bytes/sector", 0
        fail2 byte "Wrong # of root entries", 0
        fail3 byte "Wrong media descriptor", 0
        fail4 byte "Wrong FAT", 0
        fail5 byte "Wrong signature", 0